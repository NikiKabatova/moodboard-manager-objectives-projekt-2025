...
const initialColors = ['#CCDAD1', '#9CAEA9', '#788585'];
...
const imageGroups = {
  '.tall-left': [
    'images/messy/product-1.jpg',
    'images/style-tiles/fashion.jpg',
    'images/messy/life-style-1.jpg',
  ],
  '.square-mid-left': [
    'images/messy/product-2.jpg',
    'images/messy/fashion-1.jpg',
    'images/messy/life-style-2.jpg',
  ],
  '.square-mid-right': [
    'images/messy/product-3.png',
    'images/messy/fashion-2.jpg',
    'images/messy/life-style-3.jpg',
  ],
  '.wide-bottom': [
    'images/style-tiles/product.jpg',
    'images/messy/fashion-3.jpg',
    'images/style-tiles/surfer.jpg',
  ],
  '.main-hero-image': [
    'images/style-tiles/product.jpg',
    'images/style-tiles/fashion.jpg',
  ...
  '.icon-option-fb': [
    'images/icon-option/fb-1.png',
    'images/icon-option/fb-2.png',
    'images/icon-option/fb-3.png',
  ],
  '.icon-option-ig': [
    'images/icon-option/ig-1.png',
    'images/icon-option/ig-2.png',
    'images/icon-option/ig-3.png',
  ],
  '.icon-option-li': [
    'images/icon-option/li-1.png',
    'images/icon-option/li-2.png',
    'images/icon-option/li-3.png',
  ],
  '.icon-option-tt': [
    'images/icon-option/tt-1.png',
    'images/icon-option/tt-2.png',
    'images/icon-option/tt-3.png',
  ],
  '.btn-filled': [
    'images/buttons/cta-pink-1.png',
    'images/buttons/cta-blue-1.png',
    'images/buttons/cta-black-1.png',
  ],
  '.btn-outline': [
    'images/buttons/cta-pink-2.png',
    'images/buttons/cta-blue-2.png',
    'images/buttons/cta-black-2.png',
  ],
};
...
function setupImagePicker(selector, images) {
  ...
  elements.forEach((el) => {
    el.addEventListener('click', function (e) {
      ...
      if (el.matches('.icon-option-fb, .icon-option-ig, .icon-option-tt, .icon-option-li, .box.square-mid-right')) {
          picker.classList.add('column');
        }
